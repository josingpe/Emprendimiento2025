...
def abrir_gestion_empleados(page):
    ...
    banco = ft.TextField(label="Banco",options=[ft.dropdown.Option("Banco de Venezuela"),ft.dropdown.Option("Banco Nacional de Crédito (BNC)"),ft.dropdown.Option("BBVA Provincial"),ft.dropdown.Option("Banesco"),
    ft.dropdown.Option("Mercantil Banco"), ft.dropdown.Option("Banco del Tesoro"),  ft.dropdown.Option("Bancamiga"),  ft.dropdown.Option("Banplus"), ft.dropdown.Option("Bancaribe"), ft.dropdown.Option("Venezolano de Crédito"),
    ft.dropdown.Option("Banco Plaza"), ft.dropdown.Option("Banco Fondo Común"), ft.dropdown.Option("Banco DELSUR"),ft.dropdown.Option("Banco Exterior"), ft.dropdown.Option("Banco Sofitasa"), ft.dropdown.Option("Bancrecer"),
        ft.dropdown.Option("Banco Caroní"),ft.dropdown.Option("Banco Activo"),ft.dropdown.Option("100% Banco"),  ft.dropdown.Option("Mi Banco"), ft.dropdown.Option("Bicentenario (banco digital de los trabajadores y trabajadoras)")], width=input_width)
